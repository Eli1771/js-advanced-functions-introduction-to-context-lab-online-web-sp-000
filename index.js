...
function allWagesFor(emp) {
  ...
  console.log(emp.timeInEvents[0]);
  console.log(wagesEarnedOnDate(emp, emp.timeInEvents[0].date));
  return emp.timeInEvents.reduce((r, punch) => {wagesEarnedOnDate(emp, punch.date) + r});
}
